...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      'prof.rgpd.note': 'Vous pouvez exporter une copie de vos données personnelles à tout moment (portabilité RGPD).',
    ...
    en: {
      ...
      'prof.rgpd.note': 'You can export a copy of your personal data at any time (GDPR portability).',
