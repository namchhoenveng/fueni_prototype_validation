...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      'signup.field.phone_other': '🌍 Autre',
      'signup.field.phone_other_ph': 'Indicatif (ex. +33)',
      ...
      'profile.field.country_hint': 'Pré-rempli selon votre indicatif (sélectionnez manuellement si vous avez choisi « Autre »).',
    ...
    en: {
      ...
      'signup.field.phone_other': '🌍 Other',
      'signup.field.phone_other_ph': 'Country code (e.g. +33)',
      ...
      'profile.field.country_hint': 'Pre-filled based on your country code (select manually if you chose "Other").',
