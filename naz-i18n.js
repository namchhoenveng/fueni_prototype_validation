...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      'prof.completion.hint': "Ajoutez votre adresse et un contact d'urgence pour atteindre 100 %.",
      ...
      'prof.rgpd.delete_note': 'Pour supprimer votre compte, contactez notre support. <span style="color:#b0b8bf;">(La suppression en libre-service sera disponible ultérieurement.)</span>',
    ...
    en: {
      ...
      'prof.completion.label': 'Profile completed at',
      'prof.completion.hint': 'Add your address and an emergency contact to reach 100%.',
      ...
      'prof.rgpd.delete_note': 'To delete your account, contact our support. <span style="color:#b0b8bf;">(Self-service deletion will come later.)</span>',
